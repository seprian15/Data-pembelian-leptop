...
$mhs = query("SELECT * FROM data_laptop WHERE id = $id")[0];
...
<body>
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-6">
      ...
      <input type="text" name="merk_laptop" class="form-control" id="merk_laptop" placeholder="contoh : 2015" required autocomplete="off" value="<?= $mhs["merk_laptop"] ?>">
    </div>
    <div class="col-md-6">
